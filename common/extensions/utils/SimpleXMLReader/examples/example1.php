...
namespace common\extensions\utils\SimpleXMLReader\examples;

use common\extensions\utils\SimpleXMLReader\library\SimpleXMLReader;
...
class ExampleXmlReader1 extends SimpleXMLReader
{
    ...
    {
        // by node name
        $this->registerCallback("ancestor-or-self::*", array($this, "callbackPrice"));
        // by xpath
