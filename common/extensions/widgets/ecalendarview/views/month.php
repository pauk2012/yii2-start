...
<thead>
  <tr class="month-year-row">
    <th class="previous">
      <?php echo Html::a('&larr;', $previousUrl, array('class' => 'navigation-link')); ?>
    </th>
    <th class="month-year" colspan="<?php echo $daysInRow - 2; ?>">
      <?php echo $this->render($titleViewFile, array(
        'pagination' => $pagination,
      )); ?>
    </th>
    <th class="next">
      <?php echo Html::a('&rarr;', $nextUrl, array('class' => 'navigation-link')); ?>
    </th>
  </tr>
    ...
    <tr>
      <?php for($j = 0; $j < $daysInRow; ++ $i, ++ $j): ?>
        ...
        <td class="<?php echo $classesStr; ?>">
          <?php echo $this->render($itemViewFile, array(
            'data' => $data[$i],
          )); ?>
        </td>
      <?php endfor ?>
